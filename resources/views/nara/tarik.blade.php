    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-header">
                ...
                <h4 class="card-title">Tarik Saldo <span class="badge light badge-success">{{$data->kode_santri}}</span></h4>
            </div>
            <div class="card-body">
                <div class="basic-form">
                    <form method="POST" id="aksi" action="{{route('authTarik')}}">
                        @csrf
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Tarik Saldo</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" placeholder="Tarik Saldo" name="tarik">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Tanggal Penarikan</label>
                            <div class="col-sm-9">
                                <input name="tgl" class="datepicker-default form-control" id="datepicker" required>
                            </div>
                        </div>
